...
new_score_vector_high <- c() 
new_score_vector_low  <- c()
my_gene_vector_high   <- c()
my_gene_vector_low    <- c()
...
new_score_vector_high                  <- c() 
old_score_vector_high                  <- c() 
old_score_vector_low                   <- c() 
my_gene_vector_high                    <- c() 

vector_decrease_high_increase_low      <- c()
...
#   new_score_vector_high <- c(new_score_vector_high, my_gene_mean$partial_list_my_gene[1])
#   old_score_vector_high <- c(old_score_vector_high, MES_DF_1$List_RNA_Normoxia_ADRN_vs_MES_Down[1])
#   old_score_vector_low  <- c(old_score_vector_high, MES_DF_1$List_RNA_Normoxia_ADRN_vs_MES_Down[2])
#   my_gene_vector_high   <- c(my_gene_vector_high, my_gene)
#   }
#   
#   # If gene increases MES scores of Low MES group
...
tmp_matrix_1                   <- cbind( my_gene_vector_high,   new_score_vector_high)
tmp_matrix_2                   <- cbind( old_score_vector_high, old_score_vector_low)
tmp_matrix_3                   <- cbind( tmp_matrix_1,   tmp_matrix_2)


tmp_matrix_4                   <- cbind( my_gene_vector_low,   new_score_vector_low)
tmp_matrix_5                   <- cbind( old_score_vector_low, old_score_vector_low)
tmp_matrix_6                   <- cbind( tmp_matrix_4,   tmp_matrix_5)

gene_mesGroups_df              <- cbind(tmp_matrix_3, tmp_matrix_6)
gene_mesGroups_df              <- as.data.frame(gene_mesGroups_df)

##############################
############ 17) Write to file
##############################

write.table(gene_vector_decrease_high_increase_low, 
            file = paste0("../results/", "gene_vector_decrease_high_increase_low.txt"),
            sep = "\t",
            row.names = F,
            col.names = T,
            quote = F)

write.table(gene_mesGroups_df, 
            file = paste0("../results/", "gene_mesGroups_df.txt"),
            sep = "\t",
            row.names = F,
            col.names = T,
            quote = F)
